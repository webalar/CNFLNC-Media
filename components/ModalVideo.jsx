...
export default function ModalVideo({
  ...
  return (
    <div className={classes}>
      ...
      >
        <Image className="rounded-3xl shadow-2xl transition-shadow duration-300 ease-in-out aspect-video object-cover" src={thumb} width={thumbWidth} height={thumbHeight} priority alt={thumbAlt} />
        {/* Play icon */}
      ...
      <Transition show={modalOpen} as={Fragment} afterEnter={() => videoRef.current?.play()}>
        <Dialog initialFocus={videoRef} onClose={() => setModalOpen(false)}>
          {/* Modal backdrop */}
          <Transition.Child
            className="fixed inset-0 z-10 bg-black bg-opacity-80 transition-opacity"
          ...
          >
            <div className="max-w-[80vw] mx-auto h-full flex items-center">
